...
// Hello
func (ExampleService_GinClientHandlerImpl) Hello(args *HelloRequest) (*HelloResponse, error) {
	return &HelloResponse{}, nil
}

// Say
func (ExampleService_GinClientHandlerImpl) Say(args *SayRequest) (*SayResponse, error) {
